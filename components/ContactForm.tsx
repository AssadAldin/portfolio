...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      form.append("DataTime", currentDateTime);

      const response = await fetch("https://getform.io/f/ayvvjnlb", {
        method: "POST",
        body: form,
      });
      if (response?.ok) {
      ...
      console.log("Data submitting error", error);
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <Select onValueChange={handleSelectChange} disabled={loading}>
              ...
              <SelectContent className="bg-bodyColor text-white border border-white/20">
                <SelectGroup>
